...
public class PostController {
    ...
    public Iterable<PostDto> getAllPostsByUserId(@PathVariable Long userId, PaginateParam param) {
    ...
    @PatchMapping("/{id}")
    public PostDto updatePost(@PathVariable Long id, @RequestBody @Valid PostUpdateDto updateDto) {
